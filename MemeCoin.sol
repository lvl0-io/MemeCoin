...
contract MemeCoin is ERC20, Ownable(msg.sender) {
    // Added state variable for lubrication - gently does it!
    // Lubrication prevents any wallet receiving more than 1% of CoqInu in the opening days.
    ...
    function _update(
        ...
        if (lubricating && from != owner() && to != liquidityPool) {
            ...
            require(
                ...
                "Just getting warmed up, limit of 1% of Coq can be Inu until Lubrication is complete!"
            );
        }
    }
